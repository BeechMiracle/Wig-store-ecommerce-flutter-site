...
class SmallHairCareGuide extends StatefulWidget {
  const SmallHairCareGuide({Key? key}) : super(key: key);

  @override
  State<SmallHairCareGuide> createState() => _SmallHairCareGuideState();
}

class _SmallHairCareGuideState extends State<SmallHairCareGuide> {
