...
class SmallLocation extends StatefulWidget {
  const SmallLocation({Key? key}) : super(key: key);

  @override
  State<SmallLocation> createState() => _SmallLocationState();
}

class _SmallLocationState extends State<SmallLocation> {
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Text(
                            'ALAKIA ADEGBAYI DISTRICT K-MALL 265',
                            style: kAppBarTextStyle.copyWith(fontSize: 12),
                          ),
                          const SizedBox(
                            height: 10,
