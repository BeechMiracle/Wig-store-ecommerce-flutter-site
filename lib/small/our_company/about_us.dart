...
class SmallAboutUs extends StatefulWidget {
  const SmallAboutUs({Key? key}) : super(key: key);

  @override
  State<SmallAboutUs> createState() => _SmallAboutUsState();
}

class _SmallAboutUsState extends State<SmallAboutUs> {
