...
class SmallReturns extends StatefulWidget {
  const SmallReturns({Key? key}) : super(key: key);

  @override
  State<SmallReturns> createState() => _SmallReturnsState();
}

class _SmallReturnsState extends State<SmallReturns> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'WHAT IS SIMPHAIR\'S RETURN POLICY?',
                    style: kCollectionText.copyWith(
                  ...
                  Text(
                    'We want our customers to be satisfied with their purchase, so we have a flexible return policy. Here are the details:',
                    style: kAppBarTextStyle.copyWith(fontSize: 12),
                  ),
                  const SizedBox(
                    height: 15,
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Unused and unaltered wigs can be returned within 30 days of purchase for a full refund or exchange.',
                          style: kAppBarTextStyle.copyWith(fontSize: 12),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'The wig must be in its original condition, with all tags attached and in its original packaging.',
                          style: kAppBarTextStyle.copyWith(fontSize: 12),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Wigs that have been cut, styled, or altered in any way cannot be returned or exchanged.',
                          style: kAppBarTextStyle.copyWith(fontSize: 12),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Shipping and handling fees are non-refundable, and the customer is responsible for the return shipping costs.',
                          style: kAppBarTextStyle.copyWith(fontSize: 12),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Refunds will be processed within 10 business days of receiving the returned wig.',
                          style: kAppBarTextStyle.copyWith(fontSize: 12),
                        ),
                      ),
                    ],
                  ...
                  Text(
                    'If you need to return or exchange your wig, please contact our customer service team to initiate the process. We will provide you with a return shipping label and further instructions.',
                    style: kAppBarTextStyle.copyWith(fontSize: 12),
                  ),
                  const SizedBox(
                    height: 10,
                  ...
                  Text(
                    'Please note that we do not accept returns or exchanges for clearance or sale items, custom orders, or accessories. Additionally, we reserve the right to refuse any return or exchange if the wig is not in its original condition or does not meet our return policy requirements.',
                    style: kAppBarTextStyle.copyWith(fontSize: 12),
                  ),
                  const SizedBox(
                    height: 10,
                  ...
                  Text(
                    'Thank you for choosing our wig retail company, and we hope you are satisfied with your purchase.',
                    style: kAppBarTextStyle.copyWith(fontSize: 12),
                  ),
                ],
              ),
