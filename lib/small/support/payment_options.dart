...
class SmallPaymentOptions extends StatefulWidget {
  const SmallPaymentOptions({Key? key}) : super(key: key);

  @override
  State<SmallPaymentOptions> createState() => _SmallPaymentOptionsState();
}

class _SmallPaymentOptionsState extends State<SmallPaymentOptions> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'WHAT PAYMENT OPTIONS CAN I USE ON SIMPHAIR ORDERS?',
                    style: kCollectionText.copyWith(
                  ...
                  Text(
                    'We want to make buying your favorite wigs fast and easy, and accept the following payment options:',
                    style: kAppBarTextStyle.copyWith(fontSize: 12),
                  ),
                  const SizedBox(
                    height: 15,
