...
class SmallFAQs extends StatefulWidget {
  const SmallFAQs({Key? key}) : super(key: key);

  @override
  State<SmallFAQs> createState() => _SmallFAQsState();
}

class _SmallFAQsState extends State<SmallFAQs> {
