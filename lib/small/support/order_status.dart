...
class SmallOrderStatus extends StatefulWidget {
  const SmallOrderStatus({Key? key}) : super(key: key);

  @override
  State<SmallOrderStatus> createState() => _SmallOrderStatusState();
}

class _SmallOrderStatusState extends State<SmallOrderStatus> {
