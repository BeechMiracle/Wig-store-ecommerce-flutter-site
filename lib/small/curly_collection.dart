...
class SmallCurlyScreen extends StatefulWidget {
  const SmallCurlyScreen({Key? key}) : super(key: key);

  @override
  State<SmallCurlyScreen> createState() => _SmallCurlyScreenState();
}

class _SmallCurlyScreenState extends State<SmallCurlyScreen> {
