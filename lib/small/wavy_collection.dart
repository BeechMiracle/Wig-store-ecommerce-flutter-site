...
class SmallWavyScreen extends StatefulWidget {
  const SmallWavyScreen({Key? key}) : super(key: key);

  @override
  State<SmallWavyScreen> createState() => _SmallWavyScreenState();
}

class _SmallWavyScreenState extends State<SmallWavyScreen> {
