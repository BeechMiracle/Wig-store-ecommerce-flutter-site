...
class SmallShopCatalog extends StatefulWidget {
  const SmallShopCatalog({Key? key}) : super(key: key);

  @override
  State<SmallShopCatalog> createState() => _SmallShopCatalogState();
}

class _SmallShopCatalogState extends State<SmallShopCatalog> {
