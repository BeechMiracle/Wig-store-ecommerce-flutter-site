...
class SmallLogin extends StatefulWidget {
  const SmallLogin({Key? key}) : super(key: key);

  @override
  State<SmallLogin> createState() => _SmallLoginState();
}

class _SmallLoginState extends State<SmallLogin> {
