...
class SmallNewArrival extends StatefulWidget {
  const SmallNewArrival({Key? key}) : super(key: key);

  @override
  State<SmallNewArrival> createState() => _SmallNewArrivalState();
}

class _SmallNewArrivalState extends State<SmallNewArrival> {
