...
class SmallStraightScreen extends StatefulWidget {
  const SmallStraightScreen({Key? key}) : super(key: key);

  @override
  State<SmallStraightScreen> createState() => _SmallStraightScreenState();
}

class _SmallStraightScreenState extends State<SmallStraightScreen> {
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('images/hair1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Center(
