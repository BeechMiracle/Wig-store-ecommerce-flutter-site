...
class SmallSignUpPage extends StatefulWidget {
  const SmallSignUpPage({Key? key}) : super(key: key);

  @override
  State<SmallSignUpPage> createState() => _SmallSignUpPageState();
}

class _SmallSignUpPageState extends State<SmallSignUpPage> {
