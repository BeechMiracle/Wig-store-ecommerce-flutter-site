...
class SmallResetPassword extends StatefulWidget {
  const SmallResetPassword({Key? key}) : super(key: key);

  @override
  State<SmallResetPassword> createState() => _SmallResetPasswordState();
}

class _SmallResetPasswordState extends State<SmallResetPassword> {
