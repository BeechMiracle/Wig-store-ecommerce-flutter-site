...
class MidHairCareGuide extends StatefulWidget {
  const MidHairCareGuide({Key? key}) : super(key: key);

  @override
  State<MidHairCareGuide> createState() => _MidHairCareGuideState();
}

class _MidHairCareGuideState extends State<MidHairCareGuide> {
