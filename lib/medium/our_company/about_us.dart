...
class MidAboutUs extends StatefulWidget {
  const MidAboutUs({Key? key}) : super(key: key);

  @override
  State<MidAboutUs> createState() => _MidAboutUsState();
}

class _MidAboutUsState extends State<MidAboutUs> {
