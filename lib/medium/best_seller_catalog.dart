...
class MidBestSellers extends StatefulWidget {
  const MidBestSellers({Key? key}) : super(key: key);

  @override
  State<MidBestSellers> createState() => _MidBestSellersState();
}

class _MidBestSellersState extends State<MidBestSellers> {
