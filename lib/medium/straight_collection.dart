...
class MidStraightScreen extends StatefulWidget {
  const MidStraightScreen({Key? key}) : super(key: key);

  @override
  State<MidStraightScreen> createState() => _MidStraightScreenState();
}

class _MidStraightScreenState extends State<MidStraightScreen> {
