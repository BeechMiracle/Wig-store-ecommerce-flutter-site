...
class MidProductDetails extends StatefulWidget {
  final Product product;

  const MidProductDetails({
    Key? key,
    required this.product,
  }) : super(key: key);

  @override
  State<MidProductDetails> createState() => _MidProductDetailsState();
}

class _MidProductDetailsState extends State<MidProductDetails>
