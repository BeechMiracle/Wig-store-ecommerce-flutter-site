...
class MidShippingandDelivery extends StatefulWidget {
  const MidShippingandDelivery({Key? key}) : super(key: key);

  @override
  State<MidShippingandDelivery> createState() => _MidShippingandDeliveryState();
}

class _MidShippingandDeliveryState extends State<MidShippingandDelivery> {
