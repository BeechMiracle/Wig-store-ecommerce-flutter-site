...
class MidResetPassword extends StatefulWidget {
  const MidResetPassword({Key? key}) : super(key: key);

  @override
  State<MidResetPassword> createState() => _MidResetPasswordState();
}

class _MidResetPasswordState extends State<MidResetPassword> {
