...
class MidShopCatalog extends StatefulWidget {
  const MidShopCatalog({Key? key}) : super(key: key);

  @override
  State<MidShopCatalog> createState() => _MidShopCatalogState();
}

class _MidShopCatalogState extends State<MidShopCatalog> {
