...
class MidCartPage extends StatefulWidget {
  const MidCartPage({Key? key}) : super(key: key);

  @override
  State<MidCartPage> createState() => _MidCartPageState();
}

class _MidCartPageState extends State<MidCartPage> {
