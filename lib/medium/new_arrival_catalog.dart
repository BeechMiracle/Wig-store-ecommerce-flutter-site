...
class MidNewArrival extends StatefulWidget {
  const MidNewArrival({Key? key}) : super(key: key);

  @override
  State<MidNewArrival> createState() => _MidNewArrivalState();
}

class _MidNewArrivalState extends State<MidNewArrival> {
