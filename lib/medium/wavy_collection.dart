...
class MidWavyScreen extends StatefulWidget {
  const MidWavyScreen({Key? key}) : super(key: key);

  @override
  State<MidWavyScreen> createState() => _MidWavyScreenState();
}

class _MidWavyScreenState extends State<MidWavyScreen> {
