...
class MidCurlyScreen extends StatefulWidget {
  const MidCurlyScreen({Key? key}) : super(key: key);

  @override
  State<MidCurlyScreen> createState() => _MidCurlyScreenState();
}

class _MidCurlyScreenState extends State<MidCurlyScreen> {
