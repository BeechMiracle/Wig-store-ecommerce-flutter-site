...
class WavyScreen extends StatefulWidget {
  const WavyScreen({Key? key}) : super(key: key);

  @override
  State<WavyScreen> createState() => _WavyScreenState();
}

class _WavyScreenState extends State<WavyScreen> {
