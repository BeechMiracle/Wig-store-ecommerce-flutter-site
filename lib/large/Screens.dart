...
class HighPriceScreen extends StatelessWidget {
  const HighPriceScreen({Key? key}) : super(key: key);
...
class LowPriceScreen extends StatelessWidget {
  const LowPriceScreen({Key? key}) : super(key: key);
...
class WavyCollection extends StatelessWidget {
  const WavyCollection({Key? key}) : super(key: key);
...
class StraightCollection extends StatelessWidget {
  const StraightCollection({Key? key}) : super(key: key);
...
class CurlyCollection extends StatelessWidget {
  const CurlyCollection({Key? key}) : super(key: key);
...
class QuestionPage extends StatefulWidget {
  ...
  const QuestionPage({Key? key, required this.productID}) : super(key: key);
