...
class StraightScreen extends StatefulWidget {
  const StraightScreen({Key? key}) : super(key: key);

  @override
  State<StraightScreen> createState() => _StraightScreenState();
}

class _StraightScreenState extends State<StraightScreen> {
