...
class ShippingandDelivery extends StatefulWidget {
  const ShippingandDelivery({Key? key}) : super(key: key);

  @override
  State<ShippingandDelivery> createState() => _ShippingandDeliveryState();
}

class _ShippingandDeliveryState extends State<ShippingandDelivery> {
