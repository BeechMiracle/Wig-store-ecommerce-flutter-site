...
class CurlyScreen extends StatefulWidget {
  const CurlyScreen({Key? key}) : super(key: key);

  @override
  State<CurlyScreen> createState() => _CurlyScreenState();
}

class _CurlyScreenState extends State<CurlyScreen> {
